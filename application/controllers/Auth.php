...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data = [
                'name' => htmlspecialchars($this->input->post('name', true)), //true u/ menghindari cross side scripting/xxs
    ...
    public function forgotPassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templates/auth_header', $data); //memanggil templates header
            $this->load->view('auth/forgot_password'); //memanggil view login
            $this->load->view('templates/auth_footer');
        } else {
            $email = $this->input->post('email');
    ...
    public function changePassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templates/auth_header', $data); //memanggil templates header
            $this->load->view('auth/change_password'); //memanggil view login
            $this->load->view('templates/auth_footer');
        } else {
            $password = password_hash($this->input->post('password1'), PASSWORD_DEFAULT);
